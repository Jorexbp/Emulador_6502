...
public class BNE_BCC_BPL_BVC_FLAGS_FALSE {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][] { { OPCODES.INS_BNE_RL.opcodeValue, 3 }, { OPCODES.INS_BCC_RL.opcodeValue, 3 },
				{ OPCODES.INS_BPL_RL.opcodeValue, 3 }, { OPCODES.INS_BVC_RL.opcodeValue, 3 },
				{ OPCODES.INS_BCS_RL.opcodeValue, 2 }, { OPCODES.INS_BMI_RL.opcodeValue, 2 },
				{ OPCODES.INS_BEQ_RL.opcodeValue, 2 }, { OPCODES.INS_BVS_RL.opcodeValue, 2 } };
