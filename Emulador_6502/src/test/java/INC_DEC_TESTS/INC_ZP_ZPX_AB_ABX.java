...
public class INC_ZP_ZPX_AB_ABX {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][] { { OPCODES.INS_INC_ZP.opcodeValue, 5 },
				{ OPCODES.INS_INC_ZPX.opcodeValue, 6 }, { OPCODES.INS_INC_AB.opcodeValue, 6 },
				{ OPCODES.INS_INC_ABX.opcodeValue, 7 }, };
	...
	public void test() {
		...
		if (OPCODES.INS_INC_ZP.opcodeValue == OPCODE) {
		...
		} else if (OPCODES.INS_INC_ZPX.opcodeValue == OPCODE) {
			assertEquals(CPU.mem.data[0x0044], 0x04);
			assertEquals(cpu.N, false);
			assertEquals(cpu.Z, false);
			assertEquals(cpu.C, false);
			assertEquals(cpu.V, false);
		} else if (OPCODES.INS_INC_AB.opcodeValue == OPCODE) {
			assertEquals(CPU.mem.data[0x0142], 0x06);
			assertEquals(cpu.N, false);
			assertEquals(cpu.Z, false);
			assertEquals(cpu.C, false);
			assertEquals(cpu.V, false);
		} else if (OPCODES.INS_INC_ABX.opcodeValue == OPCODE) {
			assertEquals(CPU.mem.data[0x0144], 0x08);
			assertEquals(cpu.N, false);
			assertEquals(cpu.Z, false);
			assertEquals(cpu.C, false);
			assertEquals(cpu.V, false);
