...
public class TEST_LDX_ZP_ZPX_AB_ABY {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][] { { CPU.INS_LDX_ZP, 3 }, { CPU.INS_LDX_ZPY, 4 }, { CPU.INS_LDX_AB, 4 },
				{ CPU.INS_LDX_ABY, 4 } };
